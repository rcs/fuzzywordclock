...
describe "fuzzywordclock", ->
  ...
  it "should tell me what kind of datetime it is, close to a new hour", ->
    a_monday = new Date('2011-10-17 23:57:00')
    expect(fwc.fuzzy_datetime(a_monday)).toEqual("almost midnight before a workday")
